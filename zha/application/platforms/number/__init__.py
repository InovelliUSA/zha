...
class InovelliQuickStartTime(NumberConfigurationEntity):
    """Inovelli quick start time configuration entity."""
...
@register_entity(INOVELLI_CLUSTER)
class InovelliQuickStartLevel(NumberConfigurationEntity):
    """Inovelli quick start level configuration entity."""
    ...
    _cluster_handler_match = ClusterHandlerMatch(
        cluster_handlers=frozenset({CLUSTER_HANDLER_INOVELLI}),
        models=frozenset({"VZM31-SN", "VZM32-SN"}),
    )
