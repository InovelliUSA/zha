    ...
    def __init__(self, cluster: zigpy.zcl.Cluster, endpoint: Endpoint) -> None:
        ...
        if self.cluster.endpoint.model == "VZM30-SN":
            ...
            self.ZCL_INIT_ATTRS = {
                ...
                "fan_single_tap_behavior": True,
                "fan_timer_display": True,
                "aux_switch_scenes": True,
                "binding_off_to_on_sync_level": True,
                "fan_module_binding_control": True,
                "low_for_bound_control": True,
                "medium_for_bound_control": True,
                "high_for_bound_control": True,
                "led_color_for_bound_control": True,
                "local_protection": False,
                "output_mode": False,
                "on_off_led_mode": True,
                "firmware_progress_led": True,
